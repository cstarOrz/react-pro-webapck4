...
@inject('store')
@observer
class ContentDetail extends React.Component<Props,any> {
  urlConfig:UrlConfig;
  UrlConfig:any={}
  ...
  public render() {
    return (
      <div id='content-detail'>
        ...
        <ContentLike {...this.UrlConfig}></ContentLike>
        <ContentComment  {...this.UrlConfig}></ContentComment>
        <ContentPoint {...this.UrlConfig}></ContentPoint>
